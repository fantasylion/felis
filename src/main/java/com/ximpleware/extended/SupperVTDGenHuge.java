 ...
 */
public class SupperVTDGenHuge extends VTDGenHuge {
	// internal parser state
//	private static final Logger		logger					= LoggerFactory.getLogger(VTDGenHuge.class);
...
//				logger.debug("Errors in entity reference: Invalid XML char.");
			}
			return val;
			//break;
...
//									logger.debug("Error in text content: Invalid char in text content " + formatLineNumber());
//									throw new ParseExceptionHuge("Error in text content: Invalid char in text content " + formatLineNumber());
								//parser_state = STATE_TEXT;
							} else if (ch == '<') {
								break;
							} else if (ch == ']') {
